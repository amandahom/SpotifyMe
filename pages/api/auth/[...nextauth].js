...
const options = {
  providers: [
    Providers.Spotify({
      ...
      clientId: process && process.env && process.env.SPOTIFY_CLIENT_ID ? process.env.SPOTIFY_CLIENT_ID.toString() : '',
      clientSecret:
        process && process.env && process.env.SPOTIFY_CLIENT_SECRET ? process.env.SPOTIFY_CLIENT_SECRET.toString() : '',
    }),
  ],
  callbacks: {
